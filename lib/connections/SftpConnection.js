...
// this function does nothing on MacOS/Linux
function winToLin(str) {
...
SftpConnection.prototype.uploadFiles = function (aFiles) {
  ...
  self.connection.sftp(function(err, sftp) {
    ...
    aFiles.forEach(function(file) {
      var destinationFile = winToLin(path.join(self.config.getRemotePath(), file.getPath()));
...
SftpConnection.prototype.downloadFiles = function (aFiles) {
  ...
  self.connection.sftp(function(err, sftp) {
    ...
    aFiles.forEach(function(file) {
      var sourceFile = winToLin(path.join(self.config.getRemotePath(), file.getPath()));
